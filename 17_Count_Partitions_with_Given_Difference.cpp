...
// We are given an array ‘ARR’ with N positive integers and an integer D. We need to count the number
//  of ways we can partition the given array into two subsets, S1 and S2 such that S1 – S2 = D and S1
//   is always greater than or equal to S2.
